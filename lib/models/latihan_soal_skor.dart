class LatihanSoalSkor {
  ...
  LatihanSoalSkor.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null
        ? LatihanSoalSkorData.fromJson(json['data'])
        : null;
  }
...
class LatihanSoalSkorData {
  Exercise? exercise;
  Result? result;

  LatihanSoalSkorData({this.exercise, this.result});

  LatihanSoalSkorData.fromJson(Map<String, dynamic> json) {
    exercise =
